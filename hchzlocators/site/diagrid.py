...
from hubcheck.pageobjects.widgets.header import Header1 as Header
...
from hubcheck.pageobjects.widgets.header import Header1_Locators_Base_5 as Header_Locators
